...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyquickhelper-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12858&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyquickhelper-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyquickhelper` can be installed with:

```
conda install pyquickhelper
```

It is possible to list all of the versions of `pyquickhelper` available on your platform with:
